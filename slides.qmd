...
Neste caso, o número de vacinados $V$ se torna constante: $V = \rho S(0)$. Logo, o número de indivíduos suscetíveis no início da epidemia já não é mais o total, e sim $(1 - \rho) S(0)$.
